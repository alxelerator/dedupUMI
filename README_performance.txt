...
On a large sample (files R1 R2 R3) containing 96M PE seq (R1.gz of roughly 7.2GB) took 9 minutes to read and dereplicate, and took 14 minutes in addition to gzip and write.
